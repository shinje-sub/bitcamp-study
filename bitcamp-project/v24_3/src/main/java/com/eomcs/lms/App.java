...
import com.eomcs.lms.util.Iterator;
...
public class App {
  ...
  public static void main(String[] args) {
    ...
    // 그럼에도 불구하고 개발자가 다음과 같이 List 객체를 사용하려 한다면 막을수 없다.
    // => BoardHandler의 경우 아무런 작업을 수행하지 않을 것이다.
    // => 왜? List 클래스에 정의돈 메서드는 아무것도 하지 않는다.
    ...
    //    직접 사용하는 것을 막아야 한다.
    // => 이런 용도오 사용하는 문법이 "추상 클래스(abstract class)"이다.
    //
  ...
  // 이젠 Stack과 Queue는 일관된 방식으로 값을 꺼내주는 Iterator가 있기 때문에
  // 두 메서드를 하나로 합칠 수 있다.
