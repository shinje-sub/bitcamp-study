...
public abstract class AbstractList<E> implements List <E> {
  ...
  // List 규칙에 정의된 메서드 중에서 다음과 같이 size를 구현한다.
  // => 여기서 규현해도 되기 때문에 서브 클래스에게 구현을 맡기지 않고 여기서 처리하는 것이다.
  //
  public int size() {
    return size;
  }
