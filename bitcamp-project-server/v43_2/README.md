...
### 훈련3: PlatformTransactionManager 변경한다.
- com.eomcs.sql.PlatformTransactioManager 변경
  - Connection 대신 SqlSession을 다루도록 변경한다.
- com.eomcs.sql.DataLoaderLisener 변경
...
이런 경우 묶인 작업중에 한 작업이라도 오류가 발생하면,
기존에 데이터 변경 작업을 취소해야 한다.
