...
public class Exam0120 {
  ...
  public static void main(String[] args) {
    ...
    // JVM은 이 스레드의 들어있는 코드와 다음에 진행하는 코드를
    // 왔다갔다 하면서 처리할 것이다.
    new MyThread().start();
...
//
// ## CPU의 실행 시간을 쪼개서 배분하는 전략: CPU Scheculint 또는 프로세스 스케줄링
// - CPU의 실행 시간을 쪼개 코드를 실행하는 방법이다.
// 1) Round-Robin 방식
// - Windows OS에서 사용하는 방식
// - CPU 실행 시간을 일정하게 쪼개서 각 코드의 분배하는 방식
// 2) Priority 방식
...
//   - 모든 스레드는 프로세스의 종속되기 때문에 프로세스를 종료하면
//   - 스레드도 자동 종료된다.
// - 단점:
...
//   한 프로세스의 부여된 실행 시간을 다시 쪼개 스레드를 나눠주는 방식이 아니다.
