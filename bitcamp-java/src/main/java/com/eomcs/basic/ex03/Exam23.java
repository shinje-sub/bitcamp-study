...
public class Exam23 {
  ...
  public static void main(String [] args){
    ...
    System.out.println(-2147483648);// -2**31 : 4 바이트 최소 음수값
    System.out.println(2147483647); // -2**31 -1 4 바이트 최대 양수값
    ...
    System.out.println(Long.MIN_VALUE); // 8바이트 최대 정수값
    System.out.println(Long.MAX_VALUE); // 8바이트 최소 정수값
  }
}