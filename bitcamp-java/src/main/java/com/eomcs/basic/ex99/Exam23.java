...
public class Exam23 {
  ...
  java.util.Scanner scanner = new java.util.Scanner(System.in); // new 도구 생성 메모리 스캐너 도구 생성
  ...
  //   int 만들어 리턴한다.
  // => 현재 커서의 위치는 공백(white space; space/tap/new line)에 있다.
  ...
  //    enxtLine()은 nextInt()가 읽은 값 다음부터 읽기 때문에
