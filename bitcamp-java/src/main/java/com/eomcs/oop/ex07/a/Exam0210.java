...
class Score2 {
  ...
  // sum 과 aver의 값을 직접 변경하지는 못하더라도
  // 외부에서 이 값들을 조회할 수 있는 방법/수단은(method) 제공해야 한다.
  ...
  public int getSum() { // get으로 시작하는 메서를 겟터라 부른다.
    return this.sum;
  }
...
public class Exam0210 {
  public static void main(String[] args) {
    ...
    // 즉, 클래스의 맴버만 접근할수 있고 클래스 외부에서는 접근할 수 없다.
    ...
    System.out.printf("%s, %d, %d, %d, %d, %.1f\n",
        s1.name, s1.kor, s1.math, s1.eng, s1.getSum(), s1.getAver());
  }
}
