...
public class Exam0360 {
  ...
  public static void main(final String[] args) {
    ...
    // 즉 createrRunner()의 name 파라미터가 제거된다는 것이다.
  }
  ...
  Runner createRunner(final String name) {
    ...
    class A implements Runner {
       ...
       * 
       * pubilc A(Exam0360 obj, String str) { outer = obj; name = str;}
       */
      @Override
      public void run() {
        ...
        // 그래서 컴파일러는 바깥 메서더의 로컬 변수 값을 저장할
        // 필드를 클래스에 추가한다.
        // 또한 로컬 변수에 값을 받는 생성자를 만든다.
        ...
        // 위 문장은 컴파일러가 로컬 클래스의 필드를 사용하는 문장으로 바꾼다.
        // 그래서 createRunner() 메서드 호출이 끝나더라도
        // name 값을 사용할 수 있는 것이다.
        // System.out.printf("%s님이 달립니다!", this.pramName);
      }
    }
    return new A();
    // 컴파일러는 로컬 클래스의 객체를 생성할 때
    // 바깥 클래스의 객체 주소를 전달하기 위해
