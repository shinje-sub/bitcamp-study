...
public class Exam0111 {
  ...
  public static void main(String[] args) {
    ...
    // 이렇게 상위 클래스의 레퍼런스로 하위 클래스에 인스턴스를 가리킬 수 있는 이유?
    // => 하위 클래스의 인스턴스는 상위 클래스의 인스턴스 맴버를 갖고 있기 때문이다.
    // => 그래서 상위 클래스의 레퍼런스로 
    //    상위 클래스의 인스턴스 맴버를 사용하는 것을 보장한다.
    //    
    
    // 예를 들어, Vehicle 변수 v2가 Bike 객체를  가르킨다면,
    v2 = b;
    
    // v2를 통해 Vehicle의 인스턴스 변수를 접근할수 있다.
    v2.model = "티코";
    v2.capacity = 5;
