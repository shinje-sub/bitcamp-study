...
// - data sink stream class
// - 실제 데이터를 저장하는 일을 한다.
// - 예 ) FileOutputStrem, ByteArrayOutputStream, PipedOutputStream
// - data processing stream class (=decorator)
// - 데이터를 중간에서 가공하는 일을 한다.
// - 예) BufferedOutputStream, DataOutputStream, ObjectOutputStream
//
//
...
// - data sink stream class
// - 실제 데이터를 읽는 일을 한다.
// - 예) FileReader, CharArrayReader, PipedReader, StringReader
// - data processing stream class (=decorator)
// - 데이터를 중간에서 가공하는 일을 한다.
// - 예) BufferedReaderm LibeNumberReader
// 출력 : Writer
// - data sink stream class
// - 실제 데이터를 읽는 일을 한다.
