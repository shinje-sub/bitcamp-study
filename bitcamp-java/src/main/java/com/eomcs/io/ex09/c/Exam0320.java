...
public class Exam0320 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //   같은 클래스인지 검사한다.
    //   만약 다른 클래스라면 InvalidClassExcepioin 오류가 발생한다.
    //
    ...
    // - 클래스에서 내장된 스태틱 변수인 seriaVersionUID 변수의 값을 비교한다.
    //
    // serialVersionUID 스태틱 변수?
    // - java.io.Serializeble 이 붙은 클래스는 항상 이 변수를 내장한다.
    ...
    // - Member 클래스를 변경하였다.
    // - 컴파일러 또한 이 클래스의 serialVersionUID 변수의 값을 변경하였다.
