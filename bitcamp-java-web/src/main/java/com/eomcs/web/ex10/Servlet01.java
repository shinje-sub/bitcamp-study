...
public class Servlet01 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // => HTTP 응답 프로토콜
    /*
     * HTTP/1.1 200 Set-Cookie: name=hong <---- Set-Cookie 헤더에 '이름=값' 형태로 쿠키를 보낸다. Set-Cookie:age=20
     * Set-Cookie: working=true Set-Cookie: name2=홍길동 <---- URL 인코딩 하지 않은 상태
     * Set-Cookie:name3=%ED%99%8D%EA%B8%B8%EB%8F%99 <---- URL 인코딩한 예 Content-Type:
     * text/plain;charset=UTF-8 Content-Length: 35 Date: Wed, 03 Apr 2019 01:03:37 GMT
     */
